...
def coordinate_smoothing(player_tracking_transformation_filepath, results_dir):
    # opening file
    with open(player_tracking_transformation_filepath, "r") as readFile:
    ...
    # writing json file
    with open(os.path.join(results_dir, 'player_tracking_with_smoothing_results.json'), 'w') as outfile:
